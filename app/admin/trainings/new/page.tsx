...
const ROLES = ['ADMIN', 'DSPD_SUPPORT_COORDINATOR', 'DSPD_MANAGER', 'HRSS_STAFF', 'EPAS_STAFF', 'TRAINER'];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Add a new training for staff</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex space-x-4">
                <Button type="submit" disabled={loading || formData.requiredRoles.length === 0}>
